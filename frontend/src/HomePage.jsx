...
const HomePage = ({ chatHistory }) => {
  return (
    <Container>
      ...
      <Button variant="contained" component={Link} to="/app" style={{ marginTop: '16px', marginBottom: '16px'}}>
        Start A Chat
      </Button>
      <Button variant="contained" component={Link} to="/metrics" style={{ marginTop: '16px' , marginLeft: '16px', marginBottom: '16px'}}>
        Metrics
        </Button>
